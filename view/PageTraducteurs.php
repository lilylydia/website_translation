  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="opacity: .7;">
   ...
   <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Liste des traducteurs</span>
      </div>
    </div>
    ...
    <div class="row our-team">
      ...
      <div class="col-sm">
        <div class="pic">
          ...
          <i class="name text-left">Fax:  </i><i class="quote text-right">'.$row['fax'].'</i>
           </br>
          ...
          <div class="col-md-12 form-group">
                 ...
                 <input type="submit" id="submit" name="signaler" value="Signaler" class="btn btn-info px-4 rounded-0" data-toggle="modal" data-target="#exampleModal">
                        </div>         
    </div> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aidez-nous à comprendre ce qui se passe </h5>
      ...
      <div class="modal-body">
        <div class="form-check">
         ...
         <label class="form-check-label" for="defaultCheck1">Je ne suis satisfait de son travail</label>
</div>
<div class="form-check">
         <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
         <label class="form-check-label" for="defaultCheck1">Ventes interdites</label>
</div>
<div class="form-check">
         <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
         <label class="form-check-label" for="defaultCheck1">Faux compte</label>
</div>
      </div>
